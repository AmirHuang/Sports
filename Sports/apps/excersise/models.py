...
class Sports(models.Model):
    ...
    class Meta:
        verbose_name = verbose_name_plural = '运动项目'
...
class Sport_Fav(models.Model):
    ...
    class Meta:
        verbose_name = verbose_name_plural = '学生喜爱的运动'
        unique_together = ('student', 'sport')

    def __str__(self):
        return self.student.username + '喜爱' + self.sport.sport_name
...
class Schedule(models.Model):
    ...
    class Meta:
        verbose_name = verbose_name_plural = '发起约运动'
